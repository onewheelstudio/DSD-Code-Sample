...
namespace HexGame.Resources
{
    ...
    public class HexTile : MonoBehaviour
    {
        ...
        private PlaceHolderTileBehavior placeHolderBehavior;
        public PlaceHolderTileBehavior PlaceHolderBehavior
        {
            get => placeHolderBehavior ??= this.GetComponent<PlaceHolderTileBehavior>();
        }
        ...
        {
            LandmassGenerator.generationComplete += DoGridDelay;
        }
        ...
        {
            if(!LandmassGenerator.generating)
                DoGridDelay();
